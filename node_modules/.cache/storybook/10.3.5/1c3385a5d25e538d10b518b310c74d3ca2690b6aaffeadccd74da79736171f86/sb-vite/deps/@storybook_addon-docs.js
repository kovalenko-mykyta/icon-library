...
import { C as definePreviewAddon10 } from "./components-B0EfqFBr.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-BVkIrxbw.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-B8I34Qb4.js");
