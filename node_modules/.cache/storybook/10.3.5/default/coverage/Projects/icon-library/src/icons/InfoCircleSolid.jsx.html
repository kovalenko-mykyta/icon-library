...
<head>
    <title>Code coverage report for Projects/icon-library/src/icons/InfoCircleSolid.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">Projects/icon-library/src/icons</a> InfoCircleSolid.jsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const InfoCircleSolid = ({ size = 16, color = 'currentColor', className, 'aria-label': ariaLabel }) =&gt; (
  &lt;svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
