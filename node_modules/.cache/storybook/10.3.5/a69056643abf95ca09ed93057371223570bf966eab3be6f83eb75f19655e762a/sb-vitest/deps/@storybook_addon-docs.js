...
import { t as definePreviewAddon10 } from "./csf-CD64k4xw.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-DNdZ2mmj.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-DkHGdpYV.js");
